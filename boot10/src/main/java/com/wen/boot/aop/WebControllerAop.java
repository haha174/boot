...
public class WebControllerAop {  
    ...
    public void doBeforeAdvice(JoinPoint joinPoint){  
        ...
        getMethod(joinPoint.getTarget(),signature.getName());
        //AOP代理类的类（class）信息  
     ...
     * @param exception 
     */  
    @AfterThrowing(value = "execution(* com.wen.boot.controller..*.throwing(..))",throwing = "exception")  
     ...
     *
     */
    public void getMethod(Object object,String name) {
